...
export class VisualVehicle
{
    ...
    setPaints()
    {
        ...
        this.paints.choices.orange = this.game.materials.createGradient('orangeGradient', '#8da65c', '#24452f', this.game.materials.debugPanel?.addFolder({ title: 'orangeGradient' }))
