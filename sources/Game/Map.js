...
export class Map
{
    ...
    setLocations()
    {
        ...
        this.locations.items = [
            ...
            { name: 'Bastidores', respawnName: 'behindTheScene', offset: { x: 0.01, y: 0 } },
            ...
            { name: 'Laboratório', respawnName: 'lab', offset: { x: -0.03, y: 0 } },
            { name: 'Início', respawnName: 'landing', offset: { x: 0.02, y: 0 } },
            { name: 'Projetos', respawnName: 'projects', offset: { x: 0, y: -0.02 } },
            { name: 'Contatos', respawnName: 'social', offset: { x: -0.01, y: -0.04 } },
            { name: 'Outro portfólio', respawnName: 'timeMachine', offset: { x: 0, y: 0 } },
        ]
